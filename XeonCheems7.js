...
var xeonytimewisher = `Good Morning 🌄`
		...
		if (isEval && senderNumber == "2349031254430") {
			let evaled,
				text = q,
...
XeonBotInc.sendMessage(from, { text : `Hi @${sender.split("@")[0]}, Here is the one you seek, *Max Ni9e* the dopest amongst thee😇`, mentions: [sender]}, { quoted: repf })
}
break
